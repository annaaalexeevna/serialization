...
public class SerialazersTest {
    ...
    public void serializeObjectTwoLists() throws IOException, ClassNotFoundException {
        ...
        assertEquals(animalList1, Serialazers.deserialize(Paths.get("object.animal1")));
        assertEquals(animalList2, Serialazers.deserialize(Paths.get("object.animal2")));
    ...
    public void serializeObjectMyself() throws IOException, ClassNotFoundException {
        ...
        Serialazers.serializeMyself(animalList, Paths.get("object.bin1"));

        assertEquals(animalList, Serialazers.deserializeMyself(Paths.get("object.bin")));
    }

    @Test
    public void serializeObjectEmptyMyself() throws IOException, ClassNotFoundException {
        Serialazers.serialize(Collections.emptyList(), Paths.get("object.bin"));
        assertEquals(Collections.emptyList(), Serialazers.deserializeMyself(Paths.get("object.bin")));
    }
    ...
    public void serializeObjectTwoListsMyself() throws IOException, ClassNotFoundException {
        ...
        animalList2.add(new Animal("Lion", TypeOfAnimals.WILD, 20,
                Arrays.asList(new Food("Zebra", 9))));
        Serialazers.serializeMyself(animalList1, Paths.get("animalMyself1"));
        Serialazers.serializeMyself(animalList2, Paths.get("animalMyself2"));
        assertEquals(animalList1, Serialazers.deserializeMyself(Paths.get("object.animalMyself1")));
        assertEquals(animalList2, Serialazers.deserializeMyself(Paths.get("object.animalMyself2")));
        assertNotEquals(animalList1, Serialazers.deserializeMyself(Paths.get("object.animalMyself2")));
        assertNotEquals(animalList2, Serialazers.deserializeMyself(Paths.get("object.animalMyself1")));
    }

    @Test
    public void serializeObjectErrorMyself() throws ClassNotFoundException{
        try {
            Serialazers.deserializeMyself(Paths.get("emptytest"));
            fail();
        } catch (NoSuchFileException e) {
